  ...
  return (
    <>
      ...
      >
        ...
        <Paragraph>
          参加者は、本イベントへの参加にあたり、自己の氏名および電子メールアドレス、ブロックチェーンアドレス（以下、「個人情報」とします）を主催者に提供することに同意します。主催者は、これらの情報を本イベントの運営および当日の受付のため、ならびに次回以降のイベントの連絡手段として使用し、それ以外の目的で使用することはありません。
        ...
        <Paragraph>
          本イベントでは、参加者の氏名および電子メールアドレス、ブロックチェーンアドレスを収集します。これらの個人情報は、本イベントの運営、当日の受付、および参加者への情報提供、ならびに次回以降のイベントの連絡手段として使用されます。
        </Paragraph>
